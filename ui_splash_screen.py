...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>Frux's</strong> BOT", None))
        self.label_description.setText(QCoreApplication.translate("SplashScreen", u"<strong>VALORANT</strong> XP farmer", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen", u"loading...", None))
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created</strong>: Frux .C", None))
    # retranslateUi