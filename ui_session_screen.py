...
"")
        ...
        self.label_game_count = QLabel(self.frame)
        self.label_game_count.setMaximumSize(QSize(16777215, 40))
        font = QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        self.label_game_count.setFont(font)
        self.label_game_count.setAlignment(Qt.AlignBottom|Qt.AlignHCenter)
        self.label_game_count.setObjectName("label_game_count")
        self.verticalLayout_2.addWidget(self.label_game_count)
    ...
    def retranslateUi(self, MainWindow):
        ...
        #self.label_status.setText(QCoreApplication.translate("MainWindow", ""))
        self.endtask.setText(QCoreApplication.translate("MainWindow", "STOP"))
        self.label_game_count.setText(QCoreApplication.translate("MainWindow", "<strong>Game Count  </strong>: 0"))
